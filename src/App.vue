<template>
  <div id="app">
    ...
    <div id="main-view" v-bind:class="{ 'full-width': !learningEnabled }">
      <div id="main-game">
      ...
      <div id="main-rules" v-if="learningEnabled">
        <div class="row">
...
export default {
  ...
  created: function () {
    ...
    if (params.get("noLearning") || params.get("learning") === "false") {
      this.learningEnabled = false;
      // When learning is disabled, use robot character by default
...
@media (min-width: 800px) {
  ...
  #main-view.full-width #main-game {
    max-width: 500px;
    margin-left: auto;
    margin-right: auto;
  }
